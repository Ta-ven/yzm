...
class ValidCodeImg:
    ...
    def getValidCodeImg(self):
        ...
        font = ImageFont.truetype(r"C:\Windows\Fonts\LHANDW.TTF", size=self.font_size)
...
if __name__ == '__main__':
    ...
    for i in range(1000):
        ...
        with open(r'C:\Users\Administrator\Desktop\img\text.csv', "a")as fe:
            fe.write("%d,%s\n"%(i, valid_str))
        f = open(r'C:\Users\Administrator\Desktop\img\img\%d.png'%i, 'wb')
        f.write(data)
        f.close()